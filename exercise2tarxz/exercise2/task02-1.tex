...
\subfloat[$64 \times 64$]{\includegraphics[width=0.10\textwidth]{placeholder.pdf}} \hfill
\subfloat[$32 \times 32$]{\makebox[1.5\width][c]{\includegraphics[width=0.05\textwidth]{placeholder.pdf}}}
\end{figure}
%%%%%
%%%%%
%%%%%
